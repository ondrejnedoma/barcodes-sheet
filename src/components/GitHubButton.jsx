export default function GitHubButton({ href, repo }) {
  return (
    <a
      href={href}
      className="absolute top-2 right-2 md:top-2 md:right-2 flex flex-row items-center gap-1.5 no-underline text-gray-800 px-2 py-1 md:px-3 md:py-2 rounded hover:bg-gray-200 transition-colors text-xs md:text-sm whitespace-nowrap"
      target="_blank"
      rel="noopener noreferrer"
      title="Visit GitHub project page"
    >
      <svg
        width="16"
        height="16"
